...
public class FCMNotification {
    ...
    public <T> String pushNotification(String message, String type, T data) throws JsonProcessingException {
        ...
        json.put("type", type);
        json.put("data", new ObjectMapper().writeValueAsString(list));
