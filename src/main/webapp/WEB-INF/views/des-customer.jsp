...
<div ng-app="ngApp" ng-controller="ngCtrl" data-ng-init="fetchEntity('DES')">
    <div id="page-wrapper">
        <div class="header">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">អតិថិជនជាវសំបុត្រកែច្នៃ</div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>ចំនួនទំនិញ</th>
                                                        <th>ពត៏ទំនិញ</th>
                                                        <th ng-click="sort('GROOM_NAME')">កូនកំលោះ
                                                        ...
                                                        <th ng-click="sort('BRIDE_NAME')">កូនក្រមុំ
