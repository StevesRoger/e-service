...
<div ng-app="ngApp" ng-controller="ngCtrl" data-ng-init="fetchEntity('INV')">
    <div id="page-wrapper">
        <div class="header">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">អតិថិជនជាវវិក័យប័ត្រ</div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>ចំនួនទំនិញ</th>
                                                        <th>ពត៏ទំនិញ</th>
                                                        <th ng-click="sort('GROOM_NAME')">ឈ្មោះអតិថិជន
                                                        ...
                                                        <th ng-click="sort('BRIDE_NAME')">ឈ្មោះក្រុមហ៊ុន
                                                    ...
                                                    <tr ng-repeat="customer in customers|orderBy:sortKey:reverse|filter:search">
                                                        ...
                                                        <td>{{customer.ENTITIES.CUSTOMER_NAME}}</td>
